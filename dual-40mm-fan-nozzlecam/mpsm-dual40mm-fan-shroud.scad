  ...
  difference() {
    ...
    minkowski() {
      union()
      {
        ...
        hull()
        {
          ...
          translate([-nozzleBlowOutX/2-0.5,-2.5,-0.8]) rotate([15,0,0]) cube([nozzleBlowOutX+1,1,3]);
        }
      }
      sphere(r=edgeR);
    }
    ...
    union()
    {
      ...
      hull()
      {
        ...
        translate([-nozzleBlowOutX/2,-5-edgeR+1,-1]) rotate([14,0,0]) cube([nozzleBlowOutX,1,2]);
      }
    }
